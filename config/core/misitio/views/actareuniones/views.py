...
from core.misitio.models import ActaReun

from core.misitio.form import ActaReunForm
...
class ActaReunListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('core.misitio:actareu_crear')
...
class ActaReunCreateView(CreateView):
    ...
    success_url = reverse_lazy('core.misitio: actareu_listar')
